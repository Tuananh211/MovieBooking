...
import com.base.moviebooking.databinding.SchedulleChildFragment6Binding;
...
public class ScheduleChildFragment7 extends BaseFragment<SchedulleChildFragment6Binding> {
    ScheduleChildModel7 mViewModel;
    ScheduleCinemaModel scheduleCinemaModel;
    ScheduleAdapter scheduleAdapter;

    @Override
    protected int getLayoutId() {
        return R.layout.schedulle_child_fragment6;
    }
        ...
        mViewModel.dataMovie.observe(getViewLifecycleOwner(), new Observer<List<MovieSchedule>>() {
            ...
            public void onChanged(List<MovieSchedule> listMovieResponse) {
                if (listMovieResponse.size()!=0){
                    ...
                    View dialogLoadSchedule = getActivity().findViewById(R.id.dialog_load_schedule6);
                    if (dialogLoadSchedule != null) {
                        dialogLoadSchedule.setVisibility(View.GONE);
                    }
//                    getActivity().findViewById(R.id.dialog_load_schedule6).setVisibility(View.GONE);
