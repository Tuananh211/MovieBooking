...
public class RcvPhimHomeBindingImpl extends RcvPhimHomeBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.movie == variableId) {
            setMovie((com.base.moviebooking.entity.Movie) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMovie(@Nullable com.base.moviebooking.entity.Movie Movie) {
        this.mMovie = Movie;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.base.moviebooking.entity.Movie movie = mMovie;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvtName, movieName);
        }
    }
