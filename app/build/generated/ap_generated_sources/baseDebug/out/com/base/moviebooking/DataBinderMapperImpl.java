...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_CHANGEPASSFRAGMENT = 2;

  private static final int LAYOUT_CHONGHEFRAGMENT = 3;

  private static final int LAYOUT_DANGKYFRAGMENT = 4;

  private static final int LAYOUT_DANGNHAPFRAGMENT = 5;

  private static final int LAYOUT_DIALOGLOADING = 6;

  private static final int LAYOUT_DIENANHFRAGMENT = 7;

  private static final int LAYOUT_FILMINFOCHILDFRAGMENT = 8;

  private static final int LAYOUT_GIAODICHFRAGMENT = 9;

  private static final int LAYOUT_HOMEFRAGMENT = 10;

  private static final int LAYOUT_LICHCHIEUFRAGMENT = 11;
  ...
  private static final int LAYOUT_VIEWHOLDERCATEGORY = 26;
